    ...
    : levels(solver_params.L), solver_type(solver_params.solver_type)
{
	...
	zero_array_kernel_real<<<num_blocks, THREADS_PER_BLOCK>>>(this->eta0, num_scale_coeffs);
	zero_array_kernel_real<<<num_blocks, THREADS_PER_BLOCK>>>(this->qx0,  num_scale_coeffs);
	zero_array_kernel_real<<<num_blocks, THREADS_PER_BLOCK>>>(this->qy0,  num_scale_coeffs);
	zero_array_kernel_real<<<num_blocks, THREADS_PER_BLOCK>>>(this->z0,   num_scale_coeffs);
	...
	if (this->solver_type == MWDG2)
	{
		...
		zero_array_kernel_real<<<num_blocks, THREADS_PER_BLOCK>>>(this->eta1x, num_scale_coeffs);
	    zero_array_kernel_real<<<num_blocks, THREADS_PER_BLOCK>>>(this->qx1x,  num_scale_coeffs);
	    zero_array_kernel_real<<<num_blocks, THREADS_PER_BLOCK>>>(this->qy1x,  num_scale_coeffs);
	    zero_array_kernel_real<<<num_blocks, THREADS_PER_BLOCK>>>(this->z1x,   num_scale_coeffs);

		zero_array_kernel_real<<<num_blocks, THREADS_PER_BLOCK>>>(this->eta1y, num_scale_coeffs);
	    zero_array_kernel_real<<<num_blocks, THREADS_PER_BLOCK>>>(this->qx1y,  num_scale_coeffs);
	    zero_array_kernel_real<<<num_blocks, THREADS_PER_BLOCK>>>(this->qy1y,  num_scale_coeffs);
	    zero_array_kernel_real<<<num_blocks, THREADS_PER_BLOCK>>>(this->z1y,   num_scale_coeffs);
	}
}
