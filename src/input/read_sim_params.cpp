...
)
{
	...
	case 6: case 7: // dry dam break
		...
		sim_params.manning = C(0.0);
		break;
	case 8: case 9: // dry fric dam break
		sim_params.xmin = C(0.0);
		sim_params.xmax = C(50.0);
		sim_params.ymin = C(0.0);
		sim_params.ymax = C(50.0);
		...
		break;
	case 10: case 11: // building overtopping
		sim_params.xmin = C(0.0);
		sim_params.xmax = C(50.0);
		sim_params.ymin = C(0.0);
		sim_params.ymax = C(50.0);
	...
	case 12: // radial dam break
		...
		sim_params.manning = C(0.0);
		break;
	case 13: case 14: // diff and non diff topo c prop
		sim_params.xmin = C(0.0);
		...
		sim_params.manning = C(0.0);
		break;
	case 15: case 16: // triangle dam break
		sim_params.xmin = C(0.0);
		...
		break;
	case 17: case 18: // parabolic bowl, period "T" = 14.4 s
		...
		sim_params.ysz  = mesh_dim;
		sim_params.g    = C(9.80665);
		sim_params.time = C(21.6); // running for 1.5T
		sim_params.manning = C(0.0);
		break;
	default:
		break;
